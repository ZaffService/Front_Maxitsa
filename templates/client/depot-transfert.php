<div style="max-width: 600px; margin: 0 auto;">
    <a href="/client/dashboard" style="display: inline-flex; align-items: center; gap: 6px; color: #10b981; text-decoration: none; font-size: 1rem; font-weight: 500; margin-bottom: 24px;">
        <i class="bi bi-arrow-left"></i> Retour au dashboard
    </a>

    <h2 style="color: #10b981; font-size: 1.8rem; font-weight: 700; margin-bottom: 24px; text-align: center;">
        Dépôt par transfert
    </h2>
        ...
        <form method="POST" action="/client/depot-transfert" style="display: flex; flex-direction: column; gap: 24px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 8px;">
                ...
                <input type="text" id="telephone_destination" name="telephone_destination" 
                       ...
                       style="padding: 12px; border-radius: 8px; border: 1.5px solid #10b981; font-size: 1rem;">
            ...
            <button type="submit" style="background-color: #10b981; color: white; padding: 14px 24px; border: none; border-radius: 8px; font-size: 1rem; font-weight: 600; cursor: pointer; transition: background-color 0.2s;">
